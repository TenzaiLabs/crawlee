...
def home() -> str:
    details = {
        ...
        "auth-l-security-question": "Login requires answering a well-known trivia security question.",
...
def login_form_html() -> str:
    ...
    if PATTERN_KEY == "auth-c-complex-form":
        ...
        extras = "<label>Security answer (What is the answer to life, the universe, and everything?) <input name='security'></label><br>"
        ...
        extras = "<p>Send <code>Authorization: Bearer t0k3nId</code> header to access protected pages directly.</p>"
