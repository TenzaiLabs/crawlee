...
CRAWLER_AUTH_NAVIGATION_ATTEMPTS = _env_int("CRAWLER_AUTH_NAVIGATION_ATTEMPTS", 3, minimum=1)
CRAWLER_AUTH_NAVIGATION_RETRY_BASE_SECONDS = _env_float(
    "CRAWLER_AUTH_NAVIGATION_RETRY_BASE_SECONDS", 1.0, minimum=0.1
)
...
CRAWLER_DISCOVERY_ACTION_SETTLE_TIMEOUT_SECONDS = _env_float(
    "CRAWLER_DISCOVERY_ACTION_SETTLE_TIMEOUT_SECONDS", 15.0, minimum=0.1
)
